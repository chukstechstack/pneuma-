...
export const processAndUploadAvatar = async (fileBuffer, userUuid) => {
...
export const deleteAvatarFromS3 = async (uploadedFileName) => {
    try {
...
//# sourceMappingURL=ImageService.ts.js.map