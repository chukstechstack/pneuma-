 ...
 */
export const processAndUploadImage = async (fileBuffer, folder = "tasks") => {
 ...
 */
export const deleteImageFromS3 = async (fileNameOrUrl) => {
    try {
...
//# sourceMappingURL=imageUploadUtility.js.map