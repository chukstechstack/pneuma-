...
// Custom type for PostgreSQL GIN-indexed array tags or custom types if needed, 
// but text array is natively supported via text("tags").array().notNull()
// Let's define the Enum first
