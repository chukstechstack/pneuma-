  ...
  return (
    <>
      ...
      <nav className="mobile-top-nav">
        ...
        <Link to="/messages" className="mobile-nav-badge-icon" style={{ marginLeft: "12px" }}>
          <svg
            width="22"
            height="22"
            viewBox="0 0 24 24"
      ...
      <nav className="mobile-bottom-nav">
        ...
        <Link to="/profile" className={isActive("/profile")}>
          <div className="mobile-avatar-frame-bottom">
            <img src="https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fwww.gravatar.com%2Favatar%2F2c7d99fe281ecd3bcd65ab915bac6dd5%3Fs%3D250"className="mobile-avatar-img-bottom" alt="Me Profile" />
          </div>
          <span>Profile</span>
        </Link>
      </nav>
      ...
      <nav className="desktop-master-nav">
        <div className="desktop-nav-inner-container">
          <div className="desktop-nav-left-wing">
            <Link to="/home" className="desktop-nav-brand-title">Pneuma</Link>
            <div className="desktop-search-input-box-wrapper">
              ...
              <input type="text" placeholder="Search archive insights..." className="desktop-search-input-field" />
            </div>
          </div>

          <div className="desktop-nav-right-navigation-menu">
            <Link to="/home" className={`desktop-menu-item-anchor ${location.pathname === "/home" ? "active" : ""}`}>
            ...
            <Link to="/messages" className={`desktop-menu-item-anchor ${location.pathname === "/messages" ? "active" : ""}`}>
            ...
            <Link to="/notifications" className={`desktop-menu-item-anchor ${location.pathname === "/notifications" ? "active" : ""}`}>
              <div className="desktop-badge-relative-wrapper">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="menu-svg-vector-icon">
