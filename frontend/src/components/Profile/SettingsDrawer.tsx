    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/75 backdrop-blur-md animate-fade-in p-0 sm:p-4">
      ...
      <div className="w-full sm:max-w-lg max-h-[92vh] sm:max-h-[90vh] bg-[#09090b] border-t sm:border border-white/15 rounded-t-3xl sm:rounded-3xl p-5 sm:p-8 flex flex-col justify-between overflow-y-auto shadow-2xl animate-in slide-in-from-bottom sm:zoom-in-95 duration-200">
        ...
        <div>
          ...
          {/* Feedback Banners */}
          {errorMessage && (
            <div className="mt-3 p-3 rounded-xl bg-red-500/15 border border-red-500/30 text-red-400 text-sm font-sans font-medium">
              {errorMessage}
            </div>
          )}
          {successMessage && (
            <div className="mt-3 p-3 rounded-xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 text-sm font-sans font-medium">
              {successMessage}
            </div>
          )}
          ...
          {isFetching ? (
            <div className="flex flex-col items-center justify-center py-16 text-gray-400">
              ...
              <p className="text-sm font-sans tracking-wide">Fetching account records...</p>
            </div>
          ) : (
            <form onSubmit={handleSave} className="mt-5 space-y-4 sm:space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="flex items-center gap-2 text-sm font-sans font-bold text-gray-200">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-xl bg-white/[0.03] border border-white/10 text-white text-base font-medium focus:border-[#d4af37] focus:outline-none disabled:opacity-60 transition-all font-sans"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-3 sm:px-4 sm:py-3.5 rounded-xl bg-white/[0.03] border border-white/10 text-white text-base font-medium focus:border-[#d4af37] focus:outline-none disabled:opacity-60 transition-all font-sans resize-none"
                />
              </div>
              ...
              <div className="pt-2">
                {!isEditing ? (
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 py-3.5 sm:py-4 rounded-xl border border-[#d4af37]/40 bg-[#d4af37]/10 text-[#d4af37] text-sm font-sans uppercase tracking-wider hover:bg-[#d4af37] hover:text-[#010102] transition-all cursor-pointer shadow-sm font-black"
                  >
                    <Edit3 size={17} />
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex-1 py-3.5 sm:py-4 rounded-xl border border-white/15 bg-white/5 text-gray-300 text-sm font-sans uppercase tracking-wider hover:bg-white/10 transition-all cursor-pointer font-bold"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      disabled={isSaving}
                      className="flex-1 flex items-center justify-center gap-2 py-3.5 sm:py-4 rounded-xl border border-[#d4af37] bg-[#d4af37] text-[#010102] text-sm font-sans uppercase tracking-wider font-black hover:opacity-90 transition-all cursor-pointer shadow-md disabled:opacity-50"
                    >
                      {isSaving ? (
        ...
        <div className="pt-4 sm:pt-6 border-t border-white/10 mt-5 sm:mt-6 shrink-0">
          <LogoutButton className="w-full justify-center py-3.5 sm:py-4" />
        </div>
