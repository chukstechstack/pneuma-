...
export const OutpostsSection: React.FC = () => {
  ...
  return (
    <section
      id="outposts"
      className="relative py-20 md:py-32 px-6 md:px-12 max-w-[1700px] mx-auto z-20 overflow-hidden transform-gpu"
    >
      {/* Section Header */}
      <div className="flex flex-col xl:flex-row xl:items-end justify-between mb-12 md:mb-16 gap-8">
        ...
        <div className="max-w-md border-l-2 border-emerald-500/30 pl-6 py-2">
          <p className="text-base md:text-lg text-gray-300 font-serif italic leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        {outposts[0] && (
          <div className="md:col-span-8 relative h-[420px] md:h-[500px] rounded-3xl overflow-hidden border border-white/10 bg-[#0d0d14] [transform:translateZ(0)] [backface-visibility:hidden]">
            <img
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#030305] via-[#030305]/50 to-transparent p-6 md:p-10 flex flex-col justify-end pointer-events-none">
              <span className="text-emerald-400 text-xs font-black tracking-widest uppercase mb-2 md:mb-3 flex items-center gap-2">
                <ShieldCheck size={14} /> {outposts[0].location || "Frontline Outpost"}
              </span>
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-black text-white uppercase tracking-wide mb-2 md:mb-3">
            ...
            <div className="absolute top-6 right-6 w-10 h-10 rounded-full bg-black/40 border border-white/20 flex items-center justify-center">
        ...
        {outposts[1] && (
          <div className="md:col-span-4 relative h-[420px] md:h-[500px] rounded-3xl overflow-hidden border border-white/10 bg-[#0d0d14] [transform:translateZ(0)] [backface-visibility:hidden]">
            <img
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#030305] via-[#030305]/50 to-transparent p-6 md:p-10 flex flex-col justify-end pointer-events-none">
              ...
              <h3 className="text-2xl sm:text-2xl md:text-3xl font-black text-white uppercase tracking-wide mb-2 md:mb-3">
        ...
        {/* Card 3 - Network Link */}
        {outposts[2] && (
          <div className="md:col-span-5 relative h-[380px] md:h-[420px] rounded-3xl overflow-hidden border border-white/10 bg-[#0d0d14] [transform:translateZ(0)] [backface-visibility:hidden]">
            <img
        ...
        {outposts[3] && (
          <div className="md:col-span-7 relative h-[380px] md:h-[420px] rounded-3xl overflow-hidden border border-white/10 bg-[#0d0d14] [transform:translateZ(0)] [backface-visibility:hidden]">
            <img
