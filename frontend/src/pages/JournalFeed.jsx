  ...
  return (
    <div className="home-layout">
      ...
      <div className="dashboard-grid">
        <main className="timeline-feed-wrapper" style={{ gridColumn: "span 2" }}>
          
          <div className="journal-header-banner" style={{ padding: "20px 0", borderBottom: "1px solid var(--border-subtle)", marginBottom: "20px" }}>
            <h2 style={{ fontFamily: "var(--font-serif)", color: "var(--accent-gold)", margin: 0 }}>
              📖 The Chronicle Sanctuary
            </h2>
            <p style={{ color: "var(--text-muted)", fontSize: "0.85rem", marginTop: "4px" }}>
              A personal repository of your written testimonies and echoed insights.
            </p>
          </div>

          <div className="timeline-posts-container">
            {safeTasks.length === 0 ? (
              <div className="empty-journal-message" style={{ textAlign: "center", padding: "40px", color: "var(--text-muted)" }}>
                No testimonies or echoed insights saved inside this sanctuary yet.
              </div>
            ) : (
              safeTasks.map((task) => (
                <Task
